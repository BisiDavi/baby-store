...
export default function InfoList() {
  return (
    <ul className="lg:container bg-white flex-col lg:flex-row mx-4 lg:mx-4 space-y-4 lg:space-y-0 lg:mx-auto border p-8 my-8 rounded-xl flex justify-between shadow">
      {infoList.map((item) => (
